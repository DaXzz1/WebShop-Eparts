<div class="col-span-7 flex flex-col items-center gap-3">
    ...
    <div class="flex flex-col justify-center items-center mt-1">
        <span class="text-2xl font-bold">@lang('errors.api.search.title')</span>
        <span class="text-lg text-gray-500 font-medium">@lang('errors.api.search.models.title', ['car' => $car->name, 'query' => $search])</span>
    </div>
</div>
